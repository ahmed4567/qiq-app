...
export const qualityCases = [
  {
    id: "QC-7001",
    title: "Cancellation acknowledgement review",
    ownerAgentId: "A-1042",
    ownerAgentName: "Mina Hassan",
    assignedReviewer: "Aya Hassan",
    assignedReviewerId: "R-001",
    status: "Published",
    category: "Confirmation",
    priority: "High",
    score: 96,
    publishedAt: "Today, 11:12",
    summary: "Published back to the agent dashboard after review sign-off.",
  },
  {
    id: "QC-7002",
    title: "Payment follow-up case",
    ownerAgentId: "A-1088",
    ownerAgentName: "Rania Mahmoud",
    assignedReviewer: "Karim Saleh",
    ...
    score: 84,
    publishedAt: "",
    summary: "Waiting for reviewer notes before publishing.",
  },
  {
    id: "QC-7003",
    title: "Escalation response audit",
    ownerAgentId: "A-1103",
    ownerAgentName: "Youssef Adel",
    assignedReviewer: "Aya Hassan",
    assignedReviewerId: "R-001",
    status: "Assigned",
    category: "Escalation",
    ...
    score: 0,
    publishedAt: "",
    summary: "Created by admin and queued for a reviewer to pick up.",
  },
  {
    id: "QC-7004",
    title: "Booking follow-up dispute",
    ownerAgentId: "A-1124",
    ownerAgentName: "Salma Nasser",
    assignedReviewer: "Karim Saleh",
    assignedReviewerId: "R-002",
    status: "Disputed",
    category: "Booking Failure",
    priority: "High",
    score: 78,
    publishedAt: "Yesterday, 16:30",
    summary: "Agent flagged the review and requested a dispute check.",
  },
] as const;
