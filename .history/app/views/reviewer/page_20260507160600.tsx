  ...
  return (
    ...
    >
      ...
      <section className="glass-panel rounded-[28px] p-5 sm:p-7">
        ...
        <div className="grid gap-3 md:grid-cols-1 grid-rows-1 xl:grid-cols-1 ">
          {workspaceCases.assigned.map((qualityCase) => (
            <div key={qualityCase.id} className="rounded-2xl border border-white/10  bg-white/5 p-4 md:grid-cols-1">
              <div className="text-sm text-[var(--muted)] xl:grid-cols-1 ">Ready to publish
