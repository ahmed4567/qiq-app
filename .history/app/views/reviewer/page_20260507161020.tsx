    ...
    >
          ...
          <div className="space-y-3">
            {workspaceCases.assigned.map((qualityCase) => (
              <div key={qualityCase.id} className="rounded-2xl border border-white/10 bg-white/5 p-4">
                <div className="flex flex-col gap-3 inline-flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                  <div>
      ...
      <section className="glass-panel rounded-[28px] p-5 sm:p-7">
        ...
        <div className="grid gap-3 md:grid-cols-1 xl:grid-cols-1 ">
          {workspaceCases.assigned.map((qualityCase) => (
            <div key={qualityCase.id} className="rounded-2xl border border-white/10  bg-white/5 p-4 inline-flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
              <div className="text-sm text-[var(--muted)]">
