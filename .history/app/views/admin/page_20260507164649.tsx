        ...
        <div className="glass-panel rounded-[28px] p-5 sm:p-7">
          ...
          <SectionHeader title="Assignment board" subtitle="Admins can route cases to reviewers before publishing." />
            <Link
              ...
              className="brand-gradient position-absolute mt-4 rounded-2xl px-4 py-3 text-center text-sm font-semibold text-white transition hover:opacity-90"
            >
              Add New Case
            </Link>
        ...
        <div className="glass-panel rounded-[28px] p-5 sm:p-7">
          ...
          <div className="grid grid-cols-[1fr_0.9fr] gap-2 ">
            {[
              ...
              <div key={item} className="rounded-2xl border border-white/10 bg-white/5 p-2  ">
