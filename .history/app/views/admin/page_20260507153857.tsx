  ...
  return (
    ...
    >
      ...
      <section className="grid gap-6 xl:grid-cols-[1fr_0.9fr]">
        ...
        <div className="glass-panel rounded-[28px] p-5 sm:p-7">
          <SectionHeader title="Policy notes" subtitle="Why the admin view exists and what it protects." />
          <div className="space-y-3">
            {data.policies.map((policy) => (
              <div key={policy} className="rounded-2xl border border-white/10 bg-white/5 p-4 text-sm text-[var(--muted)]">
                {policy}
              </div>
            ))}
          </div>
